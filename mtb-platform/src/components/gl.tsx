...
export const SyncIcon = ({ size = 16 }: IconProps) =>
  svg(size, <path fillRule="evenodd" d="M8 2.5a5.5 5.5 0 0 0-4.9 3H5a.75.75 0 0 1 0 1.5H1.5A.75.75 0 0 1 .75 6.25V2.75a.75.75 0 0 1 1.5 0v1.36A7 7 0 0 1 15 8a.75.75 0 0 1-1.5 0A5.5 5.5 0 0 0 8 2.5Zm6.5 4.75a.75.75 0 0 1 .75.75v3.5a.75.75 0 0 1-1.5 0V10.14A7 7 0 0 1 1 8a.75.75 0 0 1 1.5 0 5.5 5.5 0 0 0 9.9 3.25H11a.75.75 0 0 1 0-1.5h3.5Z" />);
